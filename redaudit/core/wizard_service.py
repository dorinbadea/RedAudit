...
"""
RedAudit - Wizard Service Module
Copyright (C) 2026  Dorin Badea
GPLv3 License

Composition-first service for interactive prompt/menu behavior.
"""
...
class WizardService:
    """
    Service object containing interactive UI methods for RedAudit.

    It can run standalone (for tests) or proxy state access to an owning auditor.
    """

    def __init__(self, auditor: Optional[object] = None) -> None:
