...
TRANSLATIONS = {
    "en": {
        ...
        "timing_stealth": "Stealth — Slow, IDS evasion (2s delay)",
        "timing_normal": "Normal — Balanced (no delay)",
        "timing_aggressive": "Aggressive — Maximum speed (parallel bursts)",
        "go_back": "< Go Back",
    ...
    "es": {
        ...
        "wizard_profile_q": "¿Qué tipo de auditoría deseas realizar?",
        ...
        "timing_stealth": "Sigiloso — Lento, evasión de IDS (2s delay)",
        "timing_normal": "Normal — Equilibrado (sin delay)",
        "timing_aggressive": "Agresivo — Velocidad máxima (ráfagas paralelas)",
        "go_back": "< Volver",
