...
TRANSLATIONS = {
    "en": {
        ...
        "running_cve_correlation": "Running CVE correlation (NVD)...",
        ...
        "deep_strategy_adaptive": "Adaptive",
        ...
        "scanning_hosts_heartbeat": "Scanning hosts... {0}/{1} ({2}:{3:02d} elapsed)",
        "progress_elapsed": "Progress: {0}/{1} hosts ({2}:{3:02d} elapsed)",
        "net_discovery_heartbeat": "Net Discovery in progress... ({0}:{1:02d} elapsed)",
        ...
        "nuclei_detail_parallel_running": "active batches {0}/{1} | sub-batch elapsed {2}",
        "nuclei_detail_batch_running": "batch {0}/{1} | sub-batch elapsed {2}",
        "nuclei_detail_batches_complete": "batches {0}/{1} complete",
        "nuclei_detail_retry": "retry {0}",
        "nuclei_detail_split": "split depth {0}/{1}",
        ...
        "nuclei_no_findings_partial": "Nuclei completed with timeouts (no confirmed findings)",
        "nuclei_suspected": "Nuclei flagged {} suspected false positive(s)",
        "nuclei_suspected_only": "Nuclei flagged {} suspected finding(s) (no confirmed findings)",
        ...
        "nuclei_resume_budget_keep": "Use the previous Nuclei runtime budget ({} min)?",
        "nuclei_resume_budget_keep_unlimited": "Keep Nuclei runtime unlimited (no budget)?",
        "nuclei_resume_budget_prompt": "New Nuclei runtime budget in minutes (0 = unlimited)",
        "nuclei_resume_none": "No pending Nuclei resumes found.",
        "nuclei_resume_select": "Select a pending Nuclei resume:",
        "nuclei_resume_manage": "Manage resume entries",
        "nuclei_resume_manage_select": "Choose a resume management action:",
        "nuclei_resume_delete_one": "Delete one resume entry",
        "nuclei_resume_delete_all": "Delete all resume entries",
        "nuclei_resume_delete_select": "Select a resume entry to delete:",
        "nuclei_resume_delete_all_confirm": "Delete all pending resume entries ({})?",
        "nuclei_resume_deleted_one": "Resume entry deleted: {}",
        "nuclei_resume_deleted_all": "Deleted {} resume entries.",
    ...
    "es": {
        ...
        "output_dir_q": "Directorio de salida:",
        ...
        "running_cve_correlation": "Ejecutando correlación CVE (NVD)...",
        ...
        "deep_strategy_adaptive": "Adaptativo",
        ...
        "scanning_hosts_heartbeat": "Escaneando hosts... {0}/{1} ({2}:{3:02d} transcurrido)",
        "progress_elapsed": "Progreso: {0}/{1} hosts ({2}:{3:02d} transcurrido)",
        "net_discovery_heartbeat": "Net Discovery en progreso... ({0}:{1:02d} transcurrido)",
        ...
        "nuclei_detail_parallel_running": "lotes activos {0}/{1} | tiempo de sub-lote {2}",
        "nuclei_detail_batch_running": "lote {0}/{1} | tiempo de sub-lote {2}",
        "nuclei_detail_batches_complete": "lotes {0}/{1} completados",
        "nuclei_detail_retry": "reintento {0}",
        "nuclei_detail_split": "profundidad de division {0}/{1}",
        ...
        "nuclei_no_findings_partial": "Nuclei finalizado con timeouts (sin hallazgos confirmados)",
        "nuclei_suspected": "Nuclei marcó {} falso(s) positivo(s) sospechado(s)",
        "nuclei_suspected_only": "Nuclei marcó {} hallazgo(s) sospechoso(s) (sin hallazgos confirmados)",
        ...
        "nuclei_resume_budget_keep": "¿Usar el presupuesto anterior de Nuclei ({} min)?",
        "nuclei_resume_budget_keep_unlimited": "¿Mantener Nuclei sin presupuesto (ilimitado)?",
        "nuclei_resume_budget_prompt": "Nuevo presupuesto de tiempo de Nuclei en minutos (0 = ilimitado)",
        ...
        "nuclei_resume_manage": "Gestionar entradas de reanudacion",
        "nuclei_resume_manage_select": "Elige una accion de gestion de reanudaciones:",
        "nuclei_resume_delete_one": "Borrar una entrada de reanudacion",
        "nuclei_resume_delete_all": "Borrar todas las entradas de reanudacion",
        "nuclei_resume_delete_select": "Selecciona una entrada de reanudacion para borrar:",
        "nuclei_resume_delete_all_confirm": "¿Borrar todas las entradas pendientes de reanudacion ({})?",
        "nuclei_resume_deleted_one": "Entrada de reanudacion borrada: {}",
        "nuclei_resume_deleted_all": "Se borraron {} entrada(s) de reanudacion.",
