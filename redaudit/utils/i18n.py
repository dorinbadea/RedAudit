...
TRANSLATIONS = {
    "en": {
        ...
        "scope_leak_targets_added": ("[scope] Leak-follow added {0} target(s) to Nuclei selection"),
    ...
    "es": {
        ...
        "scope_leak_targets_added": (
            "[scope] Leak-follow anadio {0} objetivo(s) a la seleccion de Nuclei"
        ),
