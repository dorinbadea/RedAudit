...
| **[Report Schema](REPORT_SCHEMA.en.md)**<br>([Español](REPORT_SCHEMA.es.md)) | JSON/JSONL schema reference and field definitions. | Developers, SIEM Engineers | When integrating RedAudit outputs. |
